...
<section class="content-list" data-track="|contentlist">
    ...
    <header>
        <h1 class="title"><?php echo $cate['NEWSCATE_NAME'] ?></h1>
    </header>
    <?php 
    ...
    <div id="showContentCate">
        ...
        ?>
            ...
            <article data-aid="<?php echo $id ?>">
                ...
                <header>
                    <h2>
            <a target="_blank" href="<?php echo $link ?>" title="<?php echo $title ?>"><?php echo $title ?></a>
            </h2>
                    <p class="meta">
                        <a href="<?php echo $linkCate ?>"><?php echo $cate['NEWSCATE_NAME'] ?></a>
