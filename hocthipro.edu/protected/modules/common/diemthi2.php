						        	...
						        	<div class="list-fiter fr">
								        <ul class="list_style">
								        	<li>
												...
												<input type="text" name="keywordSchool" style="width:85%"  value="" placeholder="Nhập tên trường hoặc mã trường">
								            </li>
								                <br/>
								            <li>
								                <strong class="clblue2">Tìm kiếm theo:</strong>
								                <select class="option choice"  name="yearBenchMark" style="width:20%">
								                     <?php 
		                                                $year = 2016;
		                                                for ($i=0; $i <=7 ; $i++) {
		                                                    $textYear = $year-$i; 
								                ...
								                <select class="option choice"  name="typeSchool" style="width:20%">
								                    <option value="">--Loại trường--</option>
								                    <option value="2">Cao đẳng</option>
								                    <option value="3">Đại học</option>
								                    <option value="4">Học Viện</option>
								                </select>
								                <select class="option choice" name="matinh_School" style="width:21%">
								                ...
								                <select  class="option choice" name="examBlock" style="width:20%">
								            ...
								            <li>
									            ...
									            <span>
									            	<select style="width:63%;margin: 5px 0px 5px 5px;" class="option" name="sort_type">
